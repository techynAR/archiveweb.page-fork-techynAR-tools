...
const BANNER = `[name].js is part of the ArchiveWeb.page (Fork) by techynAR (https://archiveweb.page) Copyright (C) 2020-${new Date().getFullYear()}, Webrecorder Software. Licensed under the Affero General Public License v3.`;
